...
* V2:
	* V2.2dev:
		* Changed Sizing of SVG Files and removed the color information.
			* Icons are now generated by Javascript to reduce the number of HTTP-Calls needed.
			* (???) SVGs als prototype eigenschaft auslagern, damit es leicht überschrieben werden kann.
				* Dasselbe ist evtl. mit anderen Eigenschaften sinnvoll!? (Alles das, was sich jede Instanz mit anderen teilt.)
	* V2.1:
...
* Get rid of any extra files.
	* CSS: Can be deleted by the use of generated css rules, added to a generated Style-Tag.
	* SVG: Can be deleted by adding base-64 encoded svg code to the css-classes. => Possibly CSS-selectable icons?!
* ImageLayer Class (???)
